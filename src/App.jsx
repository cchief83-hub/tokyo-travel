...
const RESTAURANTS = {
  "가마쿠라": [
    ...
    { name: "가츠규 규카츠 가마쿠라점 ⭐4.7", area: "가마쿠라역 서쪽", note: "소고기 돈카츠 규카츠 · 레어로 튀긴 소고기를 돌판에 직접 구워먹는 방식이에요. 와규 안심·등심 중 선택 가능하고 달걀노른자 소스가 특히 맛있어요. 리뷰 1,900개 평점 4.7, 가마쿠라역 서쪽 출구 바로 · 11:00~19:30", mapUrl: "https://www.google.com/maps/place/?q=place_id:ChIJtUduJw9FGGARW6egmyUXQcA" },
  ...
  "후지카와구치코": [
    ...
    { name: "규카츠 코슈야 甲州家 ⭐4.9", area: "후지카와구치코 (숙소 바로 앞!)", note: "소고기 돈카츠 규카츠 · 평점 4.9에 리뷰 5,400개. 더 가든 숙소 바로 앞에 있어요. 레어로 튀긴 소고기를 돌판에 직접 구워먹는 방식. 양 선택 가능 (150g~). 된장국·양배추·감자샐러드·소스 3종 포함. 영어 메뉴 있음 · 10:00~21:00 · ¥2,000~3,000", mapUrl: "https://www.google.com/maps/place/?q=place_id:ChIJRWZq1QRfGWARnp8Ed6FxeX0" },
  ...
  "시즈오카": [
    { name: "숙성 야키니쿠 10 熟成焼肉10 ⭐4.5", area: "후지노미야", note: "숙성 야키니쿠 · 후지노미야 위치. 리뷰에 '이틀 연속 왔다'는 말이 있을 정도로 맛있는 야키니쿠집. 숙성육 특유의 깊은 맛이 일반 야끼니쿠랑 달라요. 가격 대비 퀄리티 훌륭. 화요일 휴무 · 17:00~22:00 · ¥2,000~6,000", mapUrl: "https://www.google.com/maps/place/?q=place_id:ChIJY-mttdnRG2ARcepgIHGnJ28" },
