...
const SCHEDULE = [
  ...
  },
  {
    ...
    items: [
      ...
      { time: "12:30", place: "시즈오카 출발 🚗", note: "오시노에서 약 1시간 30분 · 고속도로 이용", map: mapDir("静岡市 葵区") },
      { time: "14:00", place: "시즈오카 도착 · 오뎅거리", note: "시즈오카 명물 오뎅 · 이자카야 골목 분위기", map: mapSearch("静岡おでん街 青葉横丁") },
      { time: "16:30", place: "시즈오카 출발 · 숙소 복귀", note: "약 1시간 30분", map: mapDir("Funatsu 3554, Fujikawaguchiko, Yamanashi") },
      { time: "18:00", place: "더 가든 도착 · 저녁식사", note: "숙소 또는 근처 식당", map: mapSearch("富士河口湖 夕食 レストラン") },
    ],
  },
  {
...
const PLACES = {
  ...
  가마쿠라: [
    ...
    { name: "② TANAKA Barber Shop", area: "하세", note: "14:45 · 대불에서 도보 5분 · 이사랑통역되나요 촬영지 · ⚠ 사진 전 주인께 양해 필수", mapQ: "TANAKA Barber Shop Hase Kamakura", mapUrl: "https://maps.google.com/?cid=15869312336643053071", photoUrl: "https://drive.google.com/file/d/1S9M6abVDcxsRL6N8_tQLc2P8m0V_jN6w/view?usp=drivesdk" },
    { name: "③ 고쿠라쿠지역 極楽寺駅", area: "고쿠라쿠지", note: "15:00 · 차로 5분 · 이사랑통역되나요 촬영지 · 고즈넉한 에노덴 역", mapQ: "極楽寺駅", mapUrl: "https://www.google.com/maps/search/極楽寺駅+鎌倉" },
    { name: "④ 시치리가하마역 수로 포토스팟", area: "시치리가하마", note: "15:15 · 차로 5분 · 수로 끝으로 바다가 보이는 인스타 감성 스팟", mapQ: "七里ヶ浜駅 水路 鎌倉", mapUrl: "https://maps.google.com/?cid=12702870331904269387", photoUrl: "https://drive.google.com/file/d/1DFVxMk6rWIZRo9gHZepXx5YCATj0mqGu/view?usp=drivesdk" },
    { name: "⑤ 시치리가하마 고등학교 앞 건널목", area: "시치리가하마", note: "15:30 · 바로 근처 · 에노덴+바다+하늘 포토스팟", mapQ: "七里ヶ浜高校 踏切 鎌倉", mapUrl: "https://maps.google.com/?cid=422530369093211191", photoUrl: "https://drive.google.com/file/d/17upNDDb2ZuUunVAZs5O6GHE5l-cfczz1/view?usp=drivesdk" },
    { name: "⑥ 시치리가하마 해변 七里ヶ浜", area: "시치리가하마", note: "15:45 · 후지산+바다 조망 · 일몰 명소 · 산책 30분", mapQ: "七里ヶ浜海岸 鎌倉", mapUrl: "https://maps.google.com/?cid=11344940212826062752", photoUrl: "https://drive.google.com/file/d/1bJos7bdBh_JFvJ_xi4keOQ4eMQ_ZjuhK/view?usp=drivesdk" },
    { name: "⑦ 가마쿠라코코마에역 건널목", area: "가마쿠라코코마에", note: "16:20 · 차로 5분 · 슬램덩크 배경지 · 에노덴+바다 한 프레임", mapQ: "鎌倉高校前駅 踏切", mapUrl: "https://maps.google.com/?cid=1819797686801071229", photoUrl: "https://drive.google.com/file/d/1BkKHGece8qrkVxFF0-x6outDtpNSyxGz/view?usp=drivesdk" },
    { name: "⑧ 고마치도리 小町通り", area: "가마쿠라역", note: "16:45 · 기념품 · 길거리 음식 · ⚠ 17~18시 조기마감 주의", mapQ: "小町通り 鎌倉", mapUrl: "https://www.google.com/maps/search/小町通り+鎌倉" },
  ],
};
