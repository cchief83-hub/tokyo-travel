...
const SCHEDULE = [
  ...
  },
  {
    ...
    items: [
      ...
      { time: "08:45", place: "로손 편의점 아침식사 🍙", note: "히카와 시계점 근처 · 오니기리·샌드위치·따뜻한 국물 · 간편하게 해결!", map: mapSearch("ローソン 富士吉田") },
...
const RESTAURANTS = {
  "가마쿠라": [
    { name: "미요시 우동 Miyoshi ⭐⭐미슐랭", area: "고마치도리", note: "수제 우동 · 미슐랭 2스타. 면을 직접 뽑아서 쫄깃함이 남달라요. 찍어먹는 쯔케멘 스타일. 웨이팅 있으니 구글맵 예약 먼저! · 월~금 11:15~18:00 · 토~일 11:15~19:00", mapUrl: "https://www.google.com/maps/place/?q=place_id:ChIJzWCs28BFGGARvEa7rlxczIY" },
    { name: "가츠규 규카츠 가마쿠라점 ⭐4.7", area: "가마쿠라역 서쪽", note: "소고기 돈카츠 규카츠 · 평점 4.7 · 리뷰 1,900개. 와규 안심·등심 선택 가능. 달걀노른자 소스가 특히 맛있어요. 가마쿠라역 서쪽 출구 바로 · 11:00~19:30", mapUrl: "https://www.google.com/maps/place/?q=place_id:ChIJtUduJw9FGGARW6egmyUXQcA" },
    { name: "요리도코로 yoridokoro ⭐4.2", area: "이나무라가사키", note: "구운 생선 정식 · 평점 4.2 · 에노덴 철길 바로 옆 창가. 밥 먹다 에노덴이 코앞으로 지나가요. 달걀 거품 내서 밥에 비벼먹는 방식. 화요일 휴무 · 07:00~17:00 · TableCheck 예약", mapUrl: "https://www.google.com/maps/place/?q=place_id:ChIJAQA96VlPGGAR0TqpQJDAg_A" },
    { name: "Espresso D Works ⭐4.3", area: "시치리가하마", note: "오므라이스·함박스테이크 · 평점 4.3 · 시치리가하마 해변이 바로 창밖. 카드 결제만 가능 · 08:00~20:00 · 웨이팅 있음", mapUrl: "https://www.google.com/maps/place/Espresso+D+Works/@35.3059027,139.5073276,17z" },
  ],
  "후지카와구치코": [
    { name: "스시 유타카 すし豊 ⭐4.6", area: "후지요시다", note: "스시·초밥 · 평점 4.6 숨겨진 보석 같은 동네 스시집이에요. 생선이 엄청 신선하고 가격 대비 퀄리티가 훌륭해요. 노부부가 운영하는 아늑한 분위기. 리뷰에 '생애 최고의 스시'라는 말이 많아요. 수요일 휴무 · 11:30~22:00 · ¥2,000~3,000", mapUrl: "https://www.google.com/maps/place/?q=place_id:ChIJ_RvN4rlgGWARxDYnwEavBWw" },
    { name: "규카츠 코슈야 甲州家 ⭐4.9", area: "후지카와구치코 (숙소 바로 앞!)", note: "소고기 돈카츠 규카츠 · 평점 4.9에 리뷰 5,400개. 더 가든 숙소 바로 앞에 있어요. 레어로 튀긴 소고기를 돌판에 직접 구워먹는 방식. 양 선택 가능 (150g~). 영어 메뉴 있음 · 10:00~21:00 · ¥2,000~3,000", mapUrl: "https://www.google.com/maps/place/?q=place_id:ChIJRWZq1QRfGWARnp8Ed6FxeX0" },
    { name: "호토 후도 ほうとう不動 ⭐4.0", area: "가와구치코", note: "호토 전골 · 평점 4.0 · 후지산 기슭 지역의 향토 음식이에요. 납작한 면을 된장 국물에 호박·무·당근이랑 푹 끓여낸 냄비 요리예요. 후지산 보고 내려온 뒤 몸 녹이기 최고예요. 11:00~20:00", mapUrl: "https://www.google.com/maps/place/?q=place_id:ChIJb4uizkZeGWAR2UzE7ksdwc0" },
  ],
  "시즈오카": [
